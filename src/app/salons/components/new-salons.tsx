...
const NearbySalons = ({ salons, isLoading, error }: NearbySalonsProps) => {
  if (isLoading) {
    return (
      <div className="px-2">
        ...
        <div className="flex justify-center items-center h-40">
          <p className="text-gray-600">Loading Near by Salons...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="px-2">
        <Link href="/salons-nearby" className="prose lg:prose-xl">
          <h3 className="mb-2 md:mb-3 relative text-secondary font-semibold text-lg bg-base-100">
            <span className="absolute left-0 top-1/2 -translate-y-1/2 w-2 h-8 bg-primary rounded-sm"></span>
            <span className="pl-4">Near by Salons</span>
          </h3>
  ...
  if (salons.length === 0) {
    return (
      <div className="px-2">
        ...
        <div className="flex justify-center items-center h-40">
          <p className="text-gray-600">No recommended salons available.</p>
        </div>
      </div>
    );
  }
