  ...
  return products.map((item) => ({
    ...
    image: (
      <CardImage
        ...
        src={item.imageUrls?.[0] || item.image || "/placeholder.svg"} // Use imageUrls[0], fallback to image, then placeholder
...
export function mapSalons(salons: SalonCardType[]): CardType[] {
